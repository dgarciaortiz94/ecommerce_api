...
namespace App\Dashboard\Security\Application\GoogleClientAuthenticator;
...
class GoogleClientAuthenticator extends AbstractAuthenticator
{
    ...
    public function supports(Request $request): ?bool
    {
        ...
        return ClientProvider::GOOGLE === $provider;
    }
